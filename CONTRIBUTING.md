...
- [agorokh/sdlc-dial-adapter](https://github.com/agorokh/sdlc-dial-adapter) — Anthropic ↔ OpenAI translation adapter (Apache-2.0)
- [agorokh/agentic-memory-mcp](https://github.com/agorokh/agentic-memory-mcp) — Read-path MCP server for LightRAG backends (Apache-2.0)
